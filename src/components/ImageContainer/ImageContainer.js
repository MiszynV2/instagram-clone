        ...
        <div className={classes.userInformation}>
          <header>
            ...
            <span className={classes.username}>
              {imageData.photographer_username}
            </span>
          </header>
        </div>
        ...
        <div>
          ...
          <section className={classes.textInformation}>
            <div>
              <div className={classes.userImageDiv}>
                <img
                  ...
                  src={imageData.friend.profile_image.small}
                />
              </div>
            </div>
            <span className={classes.likesInformation}>
              ...
              <span style={{ margin: "0 2px" }}>others</span>
            </span>
          </section>
          <div className={classes.description}>
            <span className={classes.bold}>{imageData.photo_description} </span>
            <span>{imageData.ai_description}</span>
          </div>
        </div>
        <div className={classes.time}>
          <span className={classes.publicationTime}>
            {new Date(imageData.photo_submitted_at).toLocaleDateString()}
          </span>
        </div>
      </div>
    </article>
